...
<div class="card">
    <svg class="img" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="100%" height="100%" version="1.1"
            ...
            <g id="_1421394342400">
                <g>
                    ...
                    <polygon fill="#3C3C3B" fill-rule="nonzero"
                        points="392.07,956.52 387.24,962.41 387.24,1263.28 392.07,1277.38 784.37,724.89"></polygon>
    ...
    <div class="textBox">
        <p class="text head"><?= $etudiant['prenom']; ?>
        </p>
        <span><?= $etudiant['nom']; ?>
        </span>
        <p class="text price"><?= $etudiant['ville']; ?>
        </p>
    </div>
</div>